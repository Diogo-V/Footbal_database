 ...
 *
 * Description
 * > This library is a modified version of "DL_List.h" and "Item.h" where,
 *   "Item.h" was changed to a struct and then merged with "DL_List.h".
 *
 * > Library that contains games related functions such as creating, deleting,
 *   inserting in a list, etc.
 *
 * > Each game is represented by it's name, team1's name, team2's name, team1's
 *   score and team2's score. They are organized by entry order inside a
 *   doubly linked list.
 *
 * -------------------------------------------------------------------------- */
