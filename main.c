 ...
 *
 * Description
 * > Program that simulates a management system of a database for football
 *   games. Interaction with the program is done trough a set of commands and
 *   must be given in a specific format
 *
 * -------------------------------------------------------------------------- */
